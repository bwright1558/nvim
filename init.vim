...
command! -bang -nargs=* Rg call fzf#vim#grep("rg --column --line-number --no-heading --color=always --smart-case --hidden --no-ignore --glob '!.git/**' --glob '!node_modules/**' -- ".shellescape(<q-args>), 1, fzf#vim#with_preview(), <bang>0)
